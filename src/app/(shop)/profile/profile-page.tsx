   ...
   const [activeSection, setActiveSection] = useState<'orders' | 'wishlist' | 'address' | 'password' | 'account'>('orders');
    ...
    return (
        <section className='pt-[130px] w-full flex flex-col items-center'>
            ...
            <article className='flex w-full max-w-[1113px] px-3 py-12 gap-10 md:flex-row flex-col divide-y md:divide-x md:divide-y-0 divide-gray-200'>
                <aside className="flex md:flex-col gap-8 w-full md:max-w-[250px] md:py-12 overflow-scroll scrollbar-hide">
                    <button onClick={switchToOrders} className={`flex gap-3 items-center py-2 px-4 rounded-md transition-all duration-150 ease-in ${activeSection === 'orders' ? 'font-semibold text-black bg-neutral-200' : 'text-gray-600 hover:text-black hover:bg-neutral-100'}`}>
                    ...
                    <button onClick={switchToWishlist} className={`flex gap-3 items-center py-2 px-4 rounded-md transition-all duration-150 ease-in ${activeSection === 'wishlist' ? 'font-semibold text-black bg-neutral-200' : 'text-gray-600 hover:text-black hover:bg-neutral-100'}`}>
                    ...
                    <button onClick={switchToAddress} className={`flex gap-3 items-center py-2 px-4 rounded-md transition-all duration-150 ease-in ${activeSection === 'address' ? 'font-semibold text-black bg-neutral-200' : 'text-gray-600 hover:text-black hover:bg-neutral-100'}`}>
                    ...
                    <button onClick={switchToPassword} className={`flex gap-3 items-center py-2 px-4 rounded-md transition-all duration-150 ease-in ${activeSection === 'password' ? 'font-semibold text-black bg-neutral-200' : 'text-gray-600 hover:text-black hover:bg-neutral-100'}`}>
                    ...
                    <button onClick={switchToAccount} className={`flex gap-3 items-center py-2 px-4 rounded-md transition-all duration-150 ease-in ${activeSection === 'account' ? 'font-semibold text-black bg-neutral-200' : 'text-gray-600 hover:text-black hover:bg-neutral-100'}`}>
                ...
                <div className="md:pl-12 w-full py-6 md:py-0">

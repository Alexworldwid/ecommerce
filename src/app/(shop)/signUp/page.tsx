import ClientFormSignup from '@/app/component/forms/clientFormSignUp';
...
export const metadata: Metadata = {
  title: 'Sign Up',
  description: 'Welcome to Eccomerce signup page',
  openGraph: {
    title: 'Eccomerce signup',
        ...
        <section className='pt-[130px] w-full flex flex-col items-center gap-14'>
            <article className='w-full flex flex-col items-center bg-neutral-100 py-10'>
                <div className='w-full max-w-[1113px] flex flex-col px-3 gap-1'>
                    <h2 className='font-semibold text-2xl font-inter'>Signup</h2>
                    <PageIndicator pageTitle='Signup' />
                </div>
            </article>

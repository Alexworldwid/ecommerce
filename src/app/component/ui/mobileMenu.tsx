    ...
    return (
        ...
        >
            ...
            <ul className='flex flex-col justify-start items-center gap-8'>
                <li>
                    <Link onClick={handleCloseMenu} href="/" className='text-gray-600 text-sm font-medium font-inter leading-normal hover:text-gray-900 transition-all duration-200 ease-in'>Home</Link>
                </li>
                <li className='flex items-center justify-center gap-2 group'>
                    <Link onClick={handleCloseMenu} href="/search" className='text-gray-600 text-sm font-medium font-inter leading-normal group-hover:text-gray-900 transition-all duration-200 ease-in'>Categories</Link>
                </li>
                <li>
                    <Link onClick={handleCloseMenu} href="" className='text-gray-600 text-sm font-medium font-inter leading-normal hover:text-gray-900 transition-all duration-200 ease-in'>About</Link>
                </li>
                <li>
                    <Link onClick={handleCloseMenu} href="" className='text-gray-600 text-sm font-medium font-inter leading-normal hover:text-gray-900 transition-all duration-200 ease-in'>Contact</Link>
                </li>
            </ul>
            ...
            <div className='flex justify-center items-center gap-8 md:hidden'>
                ...
                {/* profile icon */}
                <Link onClick={handleCloseMenu} href="/profile">

        ...
        <div className='divide-y divide-y-gray-200 w-full max-w-[620px] flex flex-col py-8'>
           {
            orders.length === 0 ? (
                ...
                orders.map((order) => (
                    <div className='flex gap-8 py-4 items-center justify-between' key={order.id}>
                        ...
                        <div className='flex items-end gap-4'>
                            ...
                            <Link className=' px-6 py-3 bg-white rounded outline outline-1 outline-offset-[-1px] outline-gray-900 inline-flex justify-start items-center gap-1.5 overflow-hidden' href={`/products/${order.product_id}`}>
                                <p className='text-gray-900 text-sm font-medium font-inter leading-6'>View item</p>
                            </Link>
                        </div>
                    </div>
                ))
